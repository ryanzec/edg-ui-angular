...
- Always prefer self comment code and avoid useless comment that just describe what the code is doing
- Always early returns instead of nesting continue logic
