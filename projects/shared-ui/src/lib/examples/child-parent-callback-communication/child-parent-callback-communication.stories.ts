...
@Component({
  ...
  template: `
    <div class="space-y-2">
      ...
      <org-button orgColor="brand" (click)="messageEmitted.emit('Hello from child via output()!')">
...
@Component({
  ...
  template: `
    <div class="space-y-2">
      ...
      <org-button orgColor="secondary" (click)="onSendMessage()"> Send Message via Callback </org-button>
    </div>
  `,
})
