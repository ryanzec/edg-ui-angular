...
export const GroupedCheckboxes: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Checkboxes grouped using the GroupElementsDirective for consistent spacing.',
      },
    },
  },
  render: () => ({
    template: `
      ...
      >
        ...
        <ul expected-behaviour class="mt-1 list-inside list-disc space-y-1">
          ...
          <li>Provides consistent gap-2 spacing between checkboxes</li>
        </ul>
      </org-storybook-example-container>
    `,
    moduleMetadata: {
      imports: [Checkbox, StorybookExampleContainer, StorybookExampleContainerSection, GroupElementsDirective],
    },
  }),
};
  ...
  template: `
    ...
    >
      <org-storybook-example-container-section label="Checkbox Group in Form">
        <form [formGroup]="checkboxForm" orgGroupElements flexDirection="col">
          <org-checkbox
            name="terms"
            value="terms"
    ...
    >
      <org-storybook-example-container-section label="Select All with Indeterminate State">
        <div orgGroupElements flexDirection="col">
          ...
          <div class="ml-6" orgGroupElements flexDirection="col">
            <org-checkbox
              name="item1"
              value="item1"
