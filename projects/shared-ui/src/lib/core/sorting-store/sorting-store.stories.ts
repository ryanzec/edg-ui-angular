  ...
  template: `
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        <org-button orgColor="brand" size="small" (click)="sortingStore.toggleSort('name')">
          Toggle Sort: Name
        </org-button>
        <org-button orgColor="brand" size="small" (click)="sortingStore.toggleSort('date')">
          Toggle Sort: Date
        </org-button>
        <org-button orgColor="brand" size="small" (click)="sortingStore.toggleSort('status')">
          Toggle Sort: Status
        </org-button>
        <org-button orgColor="secondary" size="small" (click)="sortingStore.setSort('name', 'asc')">
          Set: Name ASC
        </org-button>
        <org-button orgColor="secondary" size="small" (click)="sortingStore.setSort('date', 'desc')">
          Set: Date DESC
        </org-button>
        <org-button orgColor="neutral" size="small" (click)="sortingStore.clearSort()"> Clear Sort </org-button>
      </div>
    </div>
  `,
})
