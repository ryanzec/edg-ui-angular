...
export const WithTextDisplayValues: Story = {
  ...
  render: () => ({
    ...
    `,
    moduleMetadata: {
      imports: [CheckboxToggle, StorybookExampleContainer, StorybookExampleContainerSection, GroupElementsDirective],
    },
  }),
};
...
export const GroupedToggles: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Toggles grouped using the GroupElementsDirective for consistent spacing.',
      },
    },
  },
  render: () => ({
    template: `
      ...
      >
        ...
        <ul expected-behaviour class="mt-1 list-inside list-disc space-y-1">
          ...
          <li>Provides consistent gap-2 spacing between toggles</li>
        </ul>
      </org-storybook-example-container>
    `,
    moduleMetadata: {
  ...
  template: `
    ...
    >
      <org-storybook-example-container-section label="Toggle Group in Form">
        <form [formGroup]="toggleForm" orgGroupElements flexDirection="col">
          <org-checkbox-toggle
            name="notifications"
            value="notifications"
