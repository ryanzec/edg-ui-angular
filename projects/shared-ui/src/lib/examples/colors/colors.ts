...
export class EXAMPLEColors {
  ...
  protected readonly colorCategories: ColorCategory[] = [
    {
      ...
      colors: [
        ...
        { name: 'Brand Text', cssVar: '--color-brand-text', description: 'Brand color for text' },
        { name: 'Brand Text Subtle', cssVar: '--color-brand-text-subtle', description: 'Subtle brand text' },
  ...
  protected readonly borderColors: ColorCategory[] = [
    ...
    {
      title: 'Brand & Secondary Border Colors',
      colors: [
        { name: 'Brand Border', cssVar: '--color-brand-border', description: 'Brand border color' },
        { name: 'Brand Border Subtle', cssVar: '--color-brand-border-subtle', description: 'Subtle brand border' },
        { name: 'Brand Border Bold', cssVar: '--color-brand-border-bold', description: 'Bold brand border' },
  ...
  protected readonly backgroundColors: ColorCategory[] = [
    ...
    },
    {
      ...
      colors: [
        { name: 'Brand Background', cssVar: '--color-brand-background', description: 'Brand background color' },
        {
          name: 'Brand Background Hover',
          cssVar: '--color-brand-background-hover',
          description: 'Brand background hover state',
        },
        {
          name: 'Brand Background Pressed',
          cssVar: '--color-brand-background-pressed',
          description: 'Brand background pressed state',
        },
        {
          name: 'Brand Background Subtle',
          cssVar: '--color-brand-background-subtle',
          description: 'Subtle brand background',
        },
        {
          name: 'Brand Background Hover Subtle',
          cssVar: '--color-brand-background-hover-subtle',
          description: 'Subtle brand background hover',
        },
        {
          name: 'Brand Background Pressed Subtle',
          cssVar: '--color-brand-background-pressed-subtle',
          description: 'Subtle brand background pressed',
        },
        {
          name: 'Brand Background Bold',
          cssVar: '--color-brand-background-bold',
          description: 'Bold brand background',
        },
        {
          name: 'Brand Background Hover Bold',
          cssVar: '--color-brand-background-hover-bold',
          description: 'Bold brand background hover',
        },
        {
          name: 'Brand Background Pressed Bold',
          cssVar: '--color-brand-background-pressed-bold',
          description: 'Bold brand background pressed',
        },
      ],
    },
    {
